...
from backend.core.entity_parser import EntityParser
from backend.core.model_generator import ModelGenerator
from backend.db.connection import DatabaseManager, set_db_manager
from backend.security.auth import AuthManager
from backend.api.crud_generator import CRUDGenerator
